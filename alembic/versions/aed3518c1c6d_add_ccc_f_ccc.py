...
def upgrade() -> None:
    op.add_column('assets', sa.Column('cost_center_code_from', sa.String(10), nullable=True))
    op.add_column('assets', sa.Column('cost_center_code', sa.String(10), nullable=True))
