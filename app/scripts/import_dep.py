...
async def main():
    # import argparse
    #
    # parser = argparse.ArgumentParser(description="Импорт подразделений через API")
    # parser.add_argument("--file", default="./xlsx/Аббревиатуры подразделений.xlsx", help="Путь к Excel-файлу")
    # parser.add_argument("--url", default="http://localhost:8000", help="Base URL API")
    # parser.add_argument("--token", default="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..vhPSQZxD0KxGq2KxjAe4g5b4IanWDfazj-IxgFpYR-8",required=True, help="JWT токен авторизации")
    ...
    importer = DepartmentImporter(
        ...
        excel_path="./xlsx/Аббревиатуры подразделений.xlsx"
    )
    await importer.run()
